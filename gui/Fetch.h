...
public:
  ...
  ~Fetch();
        ...
        vector<int> run(int pc_inst, int pc_branch,int branch_signal, int jump_signal, int jump_addr);      // passes to it pc of branch and branch signal. returns pc and instruction
